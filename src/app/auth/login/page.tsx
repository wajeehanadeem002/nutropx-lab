  ...
  return (
    ...
    >
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-[380px] items-center">
        <div className="min-h-[500px] w-full rounded-[1.5rem] border-2 border-black bg-white px-6 py-6 shadow-[10px_10px_0_#000000] sm:h-[500px]">
          <Link
            href="/"
          ...
          <p className="mt-2 text-xs font-normal leading-5 text-muted">
            Access your Cognitive Fitness Score, training streak, and dashboard.
          </p>
          ...
          <form action={signInAction} className="mt-5 space-y-3">
            ...
            <button
              type="submit"
              className="w-full rounded-[0.9rem] bg-black px-6 py-3 text-xs font-black uppercase text-white transition hover:translate-y-0.5"
            >
              Sign in
            </button>
          </form>
          ...
          <p className="mt-4 text-center text-xs font-medium text-muted">
            New to Nutropx Lab?{" "}
            <Link href="/auth/signup" className="font-black text-black underline">
              Create an account
            </Link>
          </p>
        </div>
